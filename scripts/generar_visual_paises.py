...
un panel Columna | Llenas | Top valores, con el % de filas llenas coloreado por semaforo:
...
def main():
    ...
    for pais in paises:
        ...
        celda(x0 + ANCHO_COL, y, ANCHO_FILL, ALTO_HEADER, "Llenas", bg="#f7f7f7", negrilla=True)

...
scripts/                          codigo que genera los consolidados y los JSON
  ...
  generar_barras_canales_completitud.py  completitud de los 8 content objects por canal (Caracol,
                                  RCN, Canal 13, Televisa, TV Azteca...), barras apiladas + JSON

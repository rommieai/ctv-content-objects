...
| `reportes/21-.../reporte-graficos-ecpm-vacio.md` | **Vigente:** graficos SVG sobre v10-a-v19: pies del reparto del gasto entre filas llenas y vacias por columna, y heatmap fila a fila de campos llenos vs eCPM (los scatter de eCPM llenas vs vacias se quitaron: no mostraban relacion) |

...
| contentLanguage | 65.7% | 66.7% | 65.7% | — | 34.3% | No se rellena (ver abajo) |
| contentIsLiveStream | 29.2% | 42.7% | 48.9% | +19.7 pp | 51.1% | Semántica de la app (curada a mano) (`app_semantica`) |
| contentCategory | 21.7% | 30.7% | 93.2% | +71.5 pp | 6.8% | Derivado del tipo IMDb (película / serie) (`derivado_tipo`) |
| contentLength | 11.9% | 23.4% | 47.8% | +35.9 pp | 52.2% | Copiado de otra ruta del mismo título (`intra_titulo`) |
